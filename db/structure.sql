...
--
-- Name: assessment_chunks; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.assessment_chunks (
    id integer NOT NULL,
...
--
-- Name: assessment_chunks_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.assessment_chunks ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.assessment_chunks_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.attempt_answers ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.attempt_answers_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: chunk_questions; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.chunk_questions (
    id integer NOT NULL,
    assessment_chunk_id integer,
    question_id integer
);


--
-- Name: chunk_questions_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.chunk_questions ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.chunk_questions_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: assessment_chunks assessment_chunks_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.assessment_chunks
    ADD CONSTRAINT assessment_chunks_pkey PRIMARY KEY (id);
...
--
-- Name: chunk_questions chunk_questions_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.chunk_questions
    ADD CONSTRAINT chunk_questions_pkey PRIMARY KEY (id);
...
--
-- Name: assessment_chunks assessment_chunks_assessment_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.assessment_chunks
    ADD CONSTRAINT assessment_chunks_assessment_id_fkey FOREIGN KEY (assessment_id) REFERENCES public.assessments(id);


--
-- Name: assessment_chunks assessment_chunks_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.assessment_chunks
    ADD CONSTRAINT assessment_chunks_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id);
...
--
-- Name: attempt_answers attempt_answers_answer_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.attempt_answers
    ADD CONSTRAINT attempt_answers_answer_id_fkey FOREIGN KEY (answer_id) REFERENCES public.answers(id);
...
ALTER TABLE ONLY public.attempt_answers
    ADD CONSTRAINT attempt_answers_attempt_id_fkey FOREIGN KEY (attempt_id) REFERENCES public.attempts(id);
...
ALTER TABLE ONLY public.attempts
    ADD CONSTRAINT attempts_assessment_id_fkey FOREIGN KEY (assessment_id) REFERENCES public.assessments(id);
...
ALTER TABLE ONLY public.bookmarks
    ADD CONSTRAINT bookmarks_question_id_fkey FOREIGN KEY (question_id) REFERENCES public.questions(id);
...
--
-- Name: chunk_questions chunk_questions_assessment_chunk_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.chunk_questions
    ADD CONSTRAINT chunk_questions_assessment_chunk_id_fkey FOREIGN KEY (assessment_chunk_id) REFERENCES public.assessment_chunks(id);


--
-- Name: chunk_questions chunk_questions_question_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.chunk_questions
    ADD CONSTRAINT chunk_questions_question_id_fkey FOREIGN KEY (question_id) REFERENCES public.questions(id);
...
--
-- Name: questions questions_subfield_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.questions
    ADD CONSTRAINT questions_subfield_id_fkey FOREIGN KEY (subfield_id) REFERENCES public.subfields(id);
